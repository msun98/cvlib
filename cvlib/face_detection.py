...
def detect_face(image, threshold=0.6, enable_gpu=False):
    ...
    if not is_initialized:
        ...
        # print(layer_names)
        # # layer_params = net.getParam(layer_Name)
        is_initialized = True
    ...
    blob = cv2.dnn.blobFromImage(cv2.resize(image,(200,200)),1.0, (300,300), (104.0,177.0,123.0))
    net.setInput(blob)
